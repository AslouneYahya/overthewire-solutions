...
# Solution:
For this problem, I tried to ssh to bandit0 using my school wifi, but for some port blocking, I couldn't. So I found an alternative to use. [google shell](https://shell.cloud.google.com/), this shell provided by google, is free to use, and it's working because the shell doesn't depend on the configuration of your local network, but it relies on the provider of the shell.
